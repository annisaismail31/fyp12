...
<section class="section main main-raised">       
	<div class="container-fluid ">
		<div class="wrap cf">
            <h1 class="projTitle">All Your Order</h1>
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        <div class="subtotal cf">
                            ...
                            <li class="totalRow"><span class="label">Subtotal</span><span class="value">RM; '.$prev_total.'</span></li>
                                ...
                                <li class="totalRow"><span class="label">Shipping</span><span class="value">RM; 0.00</span></li>
                            
                                    <li class="totalRow"><span class="label">Tax</span><span class="value">RM; 0.00</span></li>
