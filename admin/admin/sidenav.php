...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="../assets/img/gopasar.jpg">
    <link rel="icon" type="image/png" href="../assets/img/gopasar.jpg">
...
<body class="dark-edition">
    ...
    -->
            <div class="logo"><a href="index.php" class="simple-text logo-normal">
                    <img src="./assets/img/gopasar.jpg" style="width: 150px;">
                </a></div>
